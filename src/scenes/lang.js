function abc() {
  ...
  let a = {
    "English": "Here are two inspirational references that showcase unique web design styles to help guide the development of your own BBC webpage.",
    "Hindi": "ये देखिये दो प्रेरणादायक उधारण जो अद्वितीय वेब डिज़ाइन प्रदर्शित करते हैं, ये आपको अपनी BBC वेबसाइट डिज़ाइन करने में मदद करेंगे।",
    "Gujarati": "અહીં આપેલા બે સમૃદ્ધ સંદર્ભોમાં તમે વેબ ડિઝાઇનની વિવિધ સ્ટાઇલ્સ જોઈ શકો છો, જે તમારું પોતાનું બીબીસીનું વેબપેજ બનાવવામાં તમને મદદરૂપ બનશે.",
    "Marathi": "या ठिकाणी दोन प्रेरणादायी संदर्भ देण्यात येत आहेत, त्यात वेब डिझाईनच्या अनोख्या स्टाइल दिसतील. बीबीसीचे तुमचे वेबपेज तयार करण्यासाठी याची तुम्हाला मदत होईल.",
    "Punjabi": "ਇੱਥੇ ਦੋ ਪ੍ਰੇਰਨਾਦਾਇਕ ਹਵਾਲੇ ਹਨ ਜੋ ਵਿਲੱਖਣ ਵੈੱਬ ਡਿਜ਼ਾਈਨ ਦੇ ਸਟਾਈਲ ਦਿਖਾਉਂਦੇ ਹਨ ਤਾਂਕਿ ਤੁਹਾਨੂੰ ਆਪਣੇ ਬੀਬੀਸੀ ਵੈੱਬਪੇਜ ਦੇ ਵਿਕਾਸ ਬਾਰੇ ਜਾਨਣ ਲਈ ਮਦਦ ਮਿਲ ਸਕੇ।",
    "Tamil": "உங்களின் சொந்த பிபிசி வலைப்பக்கத்தை உருவாக்குவதற்கு வழிகாட்ட உதவும் தனித்துவமான வடிவமைப்பு மாதிரிகளை காண்பிக்கும் இரண்டு ஊக்கமளிக்கு குறிப்புகள் இங்கே உள்ளன.",
    "Telugu": "మీ సొంత బీబీసీ వెబ్ పేజీని తయారు చేసుకోవడానికి మీకు సహాయపడే రెండు ఉత్తేజకరమైన విలక్షణ వెబ్ డిజైన్ స్టయిల్ నమూనాలు."
